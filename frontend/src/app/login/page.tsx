...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    // Simple mock login
    login("Rafa", email || "rafa@example.com");
    ...
    <div className="flex min-h-screen items-center justify-center bg-forge-bg px-6 py-12">
      ...
      <FadeIn className="relative w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-forge-text">Bem-vindo de volta</h1>
        ...
        <div className="rounded-2xl border border-forge-border bg-forge-card p-8 shadow-xl shadow-black/20">
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                <label className="text-sm font-medium text-forge-text-secondary">Senha</label>
                <Link href="/forgot-password"  className="text-xs text-forge-accent hover:underline">Esqueceu a senha?</Link>
              </div>
              <div className="relative group">
            ...
            <Button type="submit" className="w-full bg-forge-accent text-white hover:bg-forge-accent/90 h-11 group">
              Entrar
              <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
            </Button>

            <Link href="/dashboard" className="block w-full">
              <Button type="button" variant="outline" className="w-full border-forge-border text-forge-text-secondary hover:bg-forge-bg h-11">
                Acessar Dashboard Direto (Teste)
              </Button>
            </Link>
          </form>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-forge-card px-3 text-forge-text-secondary">Ou continue com</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button 
              variant="outline" 
              className="border-forge-border hover:bg-forge-bg h-11"
        ...
        <p className="text-center mt-8 text-sm text-forge-text-secondary">
          Não tem uma conta?{" "}
          <Link href="/signup" className="text-forge-accent font-semibold hover:underline">
            Cadastre-se grátis
          </Link>
        </p>
      </FadeIn>
